...
\thesistitle{Banco de pruebas automático para equipos eléctricos y electrónicos} % El títulos de la memoria, se usa en la carátula y se puede usar el cualquier lugar del documento con el comando \ttitle
...
\author{Ing. Gonzalo Gontad} % Tu nombre, se usa en la carátula y se puede usar el cualquier lugar del documento con el comando \authorname

\director{Mg. Ing. Ramiro Alonso (FIUBA)} % El nombre del director, se usa en la carátula y se puede usar el cualquier lugar del documento con el comando \dirname
\codirector{Nombre del codirector (pertenencia)} % El nombre del codirector si lo hubiera, se usa en la carátula y se puede usar el cualquier lugar del documento con el comando \codirname.  Para activar este campo se debe descomentar la opción "codirector" en el comando \documentclass, línea 23.

\juradoUNO{Esp. Ing. Jorge Fonseca (FIUBA)} % Nombre y pertenencia del un jurado se usa en la carátula y se puede usar el cualquier lugar del documento con el comando \jur1name
...
A mi novia Sofia, por la ayuda y apoyo incondicional.

A mi familia, por acompañarme siempre.

A mi amigo Leonel, por su ayuda cuando más lo necesitaba.

A mi director, Ramiro Alonso por su buena predisposición y orientación.
