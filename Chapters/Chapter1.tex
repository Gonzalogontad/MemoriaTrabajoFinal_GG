...
\begin{figure}[htbp]
  ...
  \begin{minipage}[b]{0.47\textwidth}
    \centering
     \includegraphics[width=.47\textwidth]{./Figures/TGE.jpg}
  ...
  \begin{minipage}[b]{0.47\textwidth}
    \centering
     \includegraphics[width=.3\textwidth]{./Figures/TQLED.png}
...
\begin{itemize}
	...
	\item Cumplimiento de tiempo máximo.
	\item Cumplimiento de tiempo mínimo.
\end{itemize}

En el momento de hacer la evaluación, las pruebas de temporizadores las hacía un operario utilizando un cronómetro y el banco de preuebas de la figura \ref{fig:Probador}, donde se podían conectar hasta seis temporizadores a la vez. Usando estos elementos el operario verifica los puntos antes indicados en forma manual.
